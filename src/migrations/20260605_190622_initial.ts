...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_content_with_media\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_content_with_media_order_idx\` ON \`pages_blocks_content_with_media\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_content_with_media_parent_id_idx\` ON \`pages_blocks_content_with_media\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_content_with_media_path_idx\` ON \`pages_blocks_content_with_media\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_content_with_media_background_image_idx\` ON \`pages_blocks_content_with_media\` (\`background_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_content_with_media\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_content_with_media_order_idx\` ON \`_pages_v_blocks_content_with_media\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_content_with_media_parent_id_idx\` ON \`_pages_v_blocks_content_with_media\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_content_with_media_path_idx\` ON \`_pages_v_blocks_content_with_media\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_content_with_media_background_image_idx\` ON \`_pages_v_blocks_content_with_media\` (\`background_image_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_content_with_media\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_content_with_media\`;`)
